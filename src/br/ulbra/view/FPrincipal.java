...
public class FPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Pequisar produto");
        ...
        txtPesquisar.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnPesquisar, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        ...
        jLabel9.setText("Listagem de produtos");
        ...
        btnLimpar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/deletar.png"))); // NOI18N
        ...
        jLabel6.setText("Editar/Excluir");
        ...
        txtCod.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N

        txtNovoNome.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(txtNovoNome, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtNovoNome, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        txtListagem.setText(r);
    }//GEN-LAST:event_btnListarActionPerformed

    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        for(i=0;i<listaProdutos.length;i++)
        {
            txtListagem.setText(null);
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        while(i<listaProdutos.length && !p)
        {
        if(listaProdutos[i].equals(pesquisa))
        {
            lbRResultado.setText(listaProdutos[i] + " - O produto consta na lista");
            p = true;
        }
        else
        {
        ...
        if(!p)
        {
        lbRResultado.setText("Produto não encontrado!");
        }
    }//GEN-LAST:event_btnPesquisarActionPerformed

    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        int d;
        d = Integer.parseInt(txtCod.getText());
        if((d - 1)>=0 && (d - 1)< listaProdutos.length)
        {
        listaProdutos[d - 1] = null;
        }
        else
        {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        e = txtNovoNome.getText();
        txtNovoNome.setText(null);
        txtCod.setText(null);
        if((c - 1)>=0 && (c - 1)< listaProdutos.length)
        {
        listaProdutos[c - 1] = e;
        }
        else
